...
#analyses descriptives par code INSEE
#--- anova, modèle linéaire de th2_obs
'''
g.mean() 
g.var() 
g.corr()
'''
g=train.groupby("insee")

insee=open("C:/Users/amina/Desktop/data/Github/4AM_SID-master/insee_mean.txt","w")
insee.write(str(g.mean()))
insee.close()

insee=open("C:/Users/amina/Desktop/data/Github/4AM_SID-master/insee_var.txt","w")
insee.write(str(g.var()))
insee.close()

insee=open("C:/Users/amina/Desktop/data/Github/4AM_SID-master/insee_corr.txt","w")
insee.write(str(g.corr()))
insee.close() 
     
#analyses descriptives par echéances

g=train.groupby("ech")

ech=open("C:/Users/amina/Desktop/data/Github/4AM_SID-master/ech_mean.txt","w")
ech.write(str(g.mean()))
ech.close()

ech=open("C:/Users/amina/Desktop/data/Github/4AM_SID-master/ech_var.txt","w")
ech.write(str(g.var()))
ech.close()

ech=open("C:/Users/amina/Desktop/data/Github/4AM_SID-master/ech_corr.txt","w")
ech.write(str(g.corr()))
ech.close() 


#analyses descriptives par mois

g=train.groupby("mois_avril")
g.mean() 
g.var() 
g.corr()     
...
mod = ols('tH2_obs ~ insee+ech+capeinsSOL0+ciwcH20',data=train).fit()             
